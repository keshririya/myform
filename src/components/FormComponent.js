          ...
          <div className="inputs">
            {[
              ...
              <div key={name} className="input">
                ...
                <input
                  ...
                  className={`input-field ${errors[name] ? "invalid" : "valid"
                    }`}
                />
                {name === "password" && (
            ...
            <div className="input">
              ...
              <input
                ...
                className={`input-field ${errors.phoneNo ? "invalid" : "valid"
                  }`}
              />
            ...
            <div className="input" >
              ...
              <select style={{ "width": "520px" }}
                ...
                onChange={handleChange}
                className={`input-field ${errors.country ? "invalid" : "valid"
                  }`}
              >
            ...
            <div className="input">
              <label>City:</label>
              <select style={{ "width": "520px", "paddingTop":"12px" }}
                name="city"
                value={formData.city}
                onChange={handleChange}
